...
<body>
    <div class="card">
        ...
        <p>A new person has been captured in the system.</p>
        <table>
            <tr><td>Name:</td><td>{{ $person->name }} {{ $person->surname }}</td></tr>
            <tr><td>SA ID:</td><td>{{ $person->identityDocument->sa_id_number }}</td></tr>
            <tr><td>Mobile:</td><td>{{ $person->contactDetail->mobile_number }}</td></tr>
            <tr><td>Email:</td><td>{{ $person->contactDetail->email_address }}</td></tr>
            <tr><td>Birth Date:</td><td>{{ $person->birth_date }}</td></tr>
            <tr><td>Language:</td><td>{{ $person->language->name }}</td></tr>
            <tr><td>Interests:</td><td>{{ $person->interests->pluck('name')->join(', ') }}</td></tr>
        </table>
