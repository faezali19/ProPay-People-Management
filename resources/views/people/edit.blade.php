            ...
            <form action="{{ route('people.update', $person->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="sa_id_number" class="form-control" value="{{ $person->identityDocument->sa_id_number ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Mobile Number</label>
                        <input type="text" name="mobile_number" class="form-control" value="{{ $person->contactDetail->mobile_number ?? '' }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="email_address" class="form-control" value="{{ $person->contactDetail->email_address ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="mb-4">
                    ...
                    @php $savedInterests = $person->interests->pluck('id')->toArray(); @endphp
